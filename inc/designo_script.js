    ...
    success: function (data) {
      ...
      if (check == yes) {
        ...
        $("form[action='/cart/add'] div").last().append(
          ...
          '<button id="my-loader" style="background-color:black;width:100%; margin-top:10px;" class="btn mt-1" type="button"><i style="margin-right:10px" class="fa fa-spinner fa-spin"></i>Loading</button>'
        );
        ...
        if (str.indexOf("account") >= 0) {
          ...
          // acount page script
          var par = $('a[href$="logout"]:first').parent();
          let ifra =
                ...
                success: function (data) {
                  ...
                  if (typeof data["url"] === "undefined") {
                    ...
                    $("form[action='/cart/add'] div")
                      .last()
                      .append(
                        '<button style="width:100%; margin-top:10px; background-color:black;" type="button" id="customize" class="btn shopify-payment-button__button mt-1">customize</button>'
                      );
                  }
                },
              });
        ...
        if (str.indexOf("designo_editor") >= 0) {
          ...
          window.addEventListener("message", async function (event) {
            ...
            if (event.data.action === "add_cart") {
              ...
              var _addonPrice = formdata.variable_price;
              console.log(_addonPrice);
              var _fixedprice = formdata.fix_price;
              console.log(_fixedprice);
              debugger;
              ...
              console.log(formdata);
              //debugger;
              if (formdata.color_id != null) {
                id = formdata["super_attribute[" + formdata.color_id + "]"];
                console.log("it is id" + id);
              } else if (formdata.size_id != null) {
                ...
                items: [
                  {
                    ...
                    properties: {
                      ...
                      png: png_img,
                      _sku: formdata.product,
                      CustomPrice: formdata.addon_price,
                      _field: JSON.stringify(formdata),
                    },
                  },
                ],
              };
              ...
              formdata.append("properties[_png]", png_img);
              formdata.append("properties[_sku]", _sku);
              formdata.append("properties[CustomPrice]", _addonPrice);
              formdata.append("properties[Artwork_Setup_Fees]", _fixedprice);
              formdata.append("properties[_field]", _field);
              formdata.append("properties[upload]", blogImage, "test.png");
              var requestOptions = {
                method: "POST",
                headers: myHeaders,
                body: formdata,
